...
struct Message {
    ...
    void serialize(uint8_t* buffer) const {
        size_t offset = 0;
        memcpy(buffer + offset, &message_id, sizeof(message_id)); offset += sizeof(message_id);
        ...
        memcpy(buffer + offset, content, sizeof(content)); offset += sizeof(content);
        memcpy(buffer + offset, &timestamp, sizeof(timestamp)); offset += sizeof(timestamp);
    }
    
    void deserialize(const uint8_t* buffer) {
        size_t offset = 0;
        memcpy(&message_id, buffer + offset, sizeof(message_id)); offset += sizeof(message_id);
        ...
        memcpy(content, buffer + offset, sizeof(content)); offset += sizeof(content);
