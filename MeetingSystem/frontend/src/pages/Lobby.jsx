...
import { 
  Video, Plus, LogOut, Calendar, Users, Copy, Check, 
...
export default function Lobby() {
  ...
  const loadMeetings = async () => {
    try {
      ...
      if (data.success) {
        const parsed = typeof data.meetings === 'string' 
  ...
  const joinMeetingById = (meetingId, title, code) => {
          ...
          <div className="space-y-6">
            ...
            <div className="card p-6 card-hover">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-xl font-bold text-white">Create Meeting</h2>
                  <p className="text-sm text-gray-400">Start a new collaborative session</p>
                </div>
              </div>
            ...
            <div className="card p-6 card-hover">
              ...
              <button onClick={joinMeeting} className="btn-primary w-full flex items-center justify-center gap-2">
          ...
          <div className="card p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">{meetings.length} active session(s)</p>
              </div>
            </div>
            ...
            <div className="space-y-3 max-h-[600px] overflow-y-auto pr-2">
              {meetings.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-gray-600 mt-2">Create your first meeting to get started!</p>
                </div>
              ) : (
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 mb-2">
                          <span className="text-xs text-gray-500">
                            {new Date(meeting.created_at * 1000).toLocaleDateString()}
                          </span>
                        </div>
