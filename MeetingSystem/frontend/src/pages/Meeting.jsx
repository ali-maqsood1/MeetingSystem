...
import { 
  MessageSquare, Palette, FileText, Video as VideoIcon, 
  Send, Download, Upload, Users, X, Maximize2
} from 'lucide-react';
...
export default function Meeting() {
  ...
  const panels = [
    { id: 'chat', icon: MessageSquare, label: 'Chat', color: 'from-blue-500 to-cyan-500' },
    { id: 'whiteboard', icon: Palette, label: 'Whiteboard', color: 'from-purple-500 to-pink-500' },
    { id: 'files', icon: FileText, label: 'Files', color: 'from-green-500 to-emerald-500' },
    { id: 'video', icon: VideoIcon, label: 'Video', color: 'from-red-500 to-orange-500' },
  ];
    ...
    <div className="h-screen bg-dark-950 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <main className="flex-1 overflow-hidden">
          ...
          {activePanel === 'whiteboard' && <WhiteboardPanel meetingId={meetingId} />}
          {activePanel === 'files' && <FilesPanel meetingId={meetingId} />}
