...
private:
    ...
    std::map<uint64_t, Message> message_by_id;                 // message_id -> message 
    ...
    std::map<uint64_t, uint64_t> last_message_timestamp; 

    std::queue<std::pair<uint64_t, std::string>> indexing_queue; 
